(function () {
    ...
    function generate_class_color() {
        var forest = [145, 195, 145];
        var grass = [170*1.15, 213*1.15, 118*1.15];
        var class_color_raw_dt = {
            ...
            // top10nl
            // http://register.geostandaarden.nl/visualisatie/top10nl/1.25.0/BRT_TOP10NL_1.25_beschrijving_visualisatie.xlsx
            // aeroway / runway
            '10000': [204, 204, 204], 
            '10001': [204, 204, 204],
            '10002': [204, 204, 204],
